package com.example.tnqls.playeranrecorder;
...
public class MainActivity extends Activity
        implements View.OnClickListener, OnCompletionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 미디어 레코더 저장할 파일 생성
        mFilePath = "/sdcard/Download/gilrhyme";
    ...
    private void initMediaPlayer() {
        ...
        try {
            ...
            int point_max = mPlayer.getDuration();
